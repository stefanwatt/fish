if status is-interactive
    ...
    alias lv='/home/stefan/.local/bin/lvim'
    colorscript -r

    function nv -d "nvim appimage alias"
      alacritty -e ~/Applications/nvim.appimage $1 &
    end  
end

set -x EDITOR /home/stefan/Applications/nvim.appimage
